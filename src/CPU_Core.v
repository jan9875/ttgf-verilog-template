...
module CPU_Core (
  ...
  always @(posedge clk, posedge rst) begin
    ...
    wire signed [7:0] Imm_Gen_out_wire, Reg_data1_wire, Reg_data2_wire, ALU_Top, CPU_result_wire, ALU_Mux_top, MemData_out_wire ;
    
    wire [7:0] PC_top_wire, PCplus1_Top, SUM_top, PC_input_wire;
    wire [7:0] ALU_A_top;
